...
current_pressure_path = '/home/jack/instrument-IO/G81_standalone_pressure_logging/current_pressure.p'
...
zulip_config_file = '/home/jack/zulip-bots/standalone_bot/python-zuliprc'

client = zulip.Client(config_file=str(zulip_config_file))


## address to send message to, .e.g., ups-bot
receiving_bot_address = 'standalone-bot@nedchat.imipolex.biz'
...
print('receiving bot address: ' + receiving_bot_address)
